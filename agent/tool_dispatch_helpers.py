...
# escalate: one advisor at a time (spend is capped; it supervises its own child, so no generic deadline).
_NEVER_PARALLEL_TOOLS = frozenset({"clarify", "manage_connections", "manage_catalog", "escalate"})
